...
# plot 2
plot(datetime, as.numeric(byDate$Voltage), 
     type="l", xlab="datetime", ylab="Voltage", cex=0.2)
...
#plot 4
plot(datetime, as.numeric(byDate$Global_reactive_power), 
     type="l", xlab="datetime", ylab="Global_reactive_power", cex=0.2)
